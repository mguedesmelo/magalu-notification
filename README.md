...
```
git clone [[https://github.com/mguedesmelo/desafio-pitang.git](https://github.com/mguedesmelo/magalu-notification.git)](https://github.com/mguedesmelo/magalu-notification.git)
```
